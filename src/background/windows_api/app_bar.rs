...
use libs_core::state::{FancyToolbarSide, TaskbarSide};
...
impl From<TaskbarSide> for AppBarDataEdge {
    fn from(val: TaskbarSide) -> Self {
        match val {
            TaskbarSide::Left => AppBarDataEdge::Left,
            TaskbarSide::Top => AppBarDataEdge::Top,
            TaskbarSide::Right => AppBarDataEdge::Right,
            TaskbarSide::Bottom => AppBarDataEdge::Bottom,
        }
    }
}
...
impl AppBarData {
    ...
    pub fn set_callback_message(&mut self, msg: u32) {
        self.0.uCallbackMessage = msg;
    }
